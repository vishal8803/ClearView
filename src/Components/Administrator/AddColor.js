...
export default function AddColor(){
    ...
    const handleSubmit = async()=>{
        ...
        if(!err)
        {
            ...
            formdata.append("colorname" , getColor)
    ...
    return (
        ...
        <h1 style={{textAlign:"center",letterSpacing:2,fontFamily:"cursive"}}>
          <span><img src={'/glasscart.png'} width={50} ></img></span><span> Add Color</span> </h1>
          <Grid container spacing={1}>
              <Grid item xs={6}>
            <TextField label='Color Name' onChange={(event)=>setColor(event.target.value)}  variant='outlined' fullWidth  />
            </Grid>
            <Grid item xs={6}>
      ...
      <Grid item xs={12}>
        <Button onClick={()=>handleSubmit()} variant="contained" fullWidth color="primary">Add Color</Button>
      </Grid>
      </Grid>
      <ToastContainer
      position="top-right"
